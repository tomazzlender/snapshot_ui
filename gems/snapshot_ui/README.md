...
**Using Rails?** The [`snapshot_ui-rails`](https://github.com/tomazzlender/snapshot_ui/tree/main/gems/snapshot_ui-rails)
gem wires all of this into Rails so it works out of the
